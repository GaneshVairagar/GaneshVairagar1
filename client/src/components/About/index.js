    ...
    <Container id="about" maxW={"5xl"} py={12} isLazy>
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
        <Stack spacing={4}>
          ...
          <Heading>Hello Friends, I'm Ganesh Vairagar</Heading>
          <Text color={"gray.500"} fontSize={"lg"}>
          A self-taught programmer who enjoys learning more about programming.
          I have a good knowledge of web development. I also like learning new things.
          <br>A Tea 🍵 Lover and sometimes coffee☕.</br>
          <br>The Sport I love is Cricket🏏.</br>
           
          </Text>
          <Text color={"gray.500"} fontSize={"md"}>
            I know Some Of the Stacks
          </Text>
